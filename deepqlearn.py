...
def train(net, start):
    ...
    imageData = resize_and_colour(imageData)
    ...
    for iteration in range(net.num_iterations):
        ...
        imageNext = resize_and_colour(imageNext)
        ...
        memory.nextPos(state, action, reward, state_1, terminal)
...
def test(net):
    ...
    image_data = resize_and_colour(image_data)
