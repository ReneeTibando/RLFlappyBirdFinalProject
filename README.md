...
<div class="snippet-clipboard-content position-relative overflow-auto"><pre><code>python deepqlearn.py train
    ...
    <clipboard-copy aria-label="Copy" class="ClipboardButton btn js-clipboard-copy m-2 p-0 tooltipped-no-delay" data-copy-feedback="Copied!" data-tooltip-direction="w" value="python deepqlearn.py train
